...
class ModelOptions:
    def __init__(self):
        ...
        parser.add_argument('--lr', type=float, default=5e-4, metavar='LR', help='learning rate (default: 3e-4)')
        parser.add_argument('--lr-decay-rate', type=float, default=0.1, help='learning rate exponentially decay rate (default: 0.1)')
        parser.add_argument('--lr-decay-steps', type=float, default=5e10, help='learning rate exponentially decay steps (default: 5e5)')
