...
class ModelOptions:
    def __init__(self):
        ...
        parser.add_argument('--lr', type=float, default=5e-3, metavar='LR', help='learning rate (default: 3e-4)')
        parser.add_argument('--lr-decay-rate', type=float, default=0.1, help='learning rate exponentially decay rate (default: 0.1)')
        parser.add_argument('--lr-decay-steps', type=float, default=25e2, help='learning rate exponentially decay steps (default: 5e5)')
        ...
        parser.add_argument('--save-interval', type=int, default=100, help='how many batches to wait before saving model (default: 1000)')
        ...
        parser.add_argument('--sample-interval', type=int, default=100, help='how many batches to wait before sampling (default: 1000)')
